...
function Contact(): React.ReactElement {
  ...
  return (
    <div style={wrapper}>
      ...
      <p>{t('contactText.1')}<a href="https://nonhuman-nonsense.com">Nonhuman&nbsp;Nonsense</a>{t('contactText.2')}<a href="https://vindelalvenbiosfar.se/">{t('biosphere')}</a>, <a href="https://www.gundegastrauberga.com/">Gundega&nbsp;Strauberga</a>, Jonas Thunberg, Johannes Rydinger, <a href="https://www.polymorf.se/">Albin&nbsp;Karlsson</a>{t('contactText.3')}</p>
