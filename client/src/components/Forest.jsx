...
function Forest({ currentSpeakerId, isPaused, audioContext }) {
    ...
    const characters = [//Ratio is video width / height
        { ref: useRef(null), id: "salmon", type: "transparent", audio: 0.3, zoom: 60, height: 9, left: 2.5, bottom: 42.5, ratio: 934 / 450 },
        { ref: useRef(null), id: "bird", type: "transparent", height: 14, left: 12.5, bottom: 52, ratio: 708 / 612 },
        { ref: useRef(null), id: "bumblebee", type: "transparent", audio: 0.3, zoom: 60, height: 10, left: -48, bottom: 44, ratio: 786 / 646 },
        { ref: useRef(null), id: "concortapine", type: "image", height: 27, left: -73, bottom: 13, ratio: 724 / 918 },
        { ref: useRef(null), id: "pine", type: "transparent", audio: 0.3, zoom: 100, height: 61, left: 26, bottom: 0, ratio: 1104 / 1920 },
        { ref: useRef(null), id: "reindeer", type: "transparent", audio: 0.3, height: 16, left: -26.5, bottom: 27, ratio: 1040 / 956 },
        { ref: useRef(null), id: "windturbine", type: "transparent", audio: 0.3, height: 22, left: 1, bottom: 69.5, ratio: 1066 / 946 },
        { ref: useRef(null), id: "treeharvester", type: "transparent", audio: 0.3, zoom: 80, height: 19, left: 57.5, bottom: 1, ratio: 674 / 900 },
        { ref: useRef(null), id: "kota", type: "transparent", always_on: true, height: 35, left: 54, bottom: 20, ratio: 574 / 1000 },
        { ref: useRef(null), id: "lichen", type: "transparent", audio: 0.3, height: 25, left: 40, bottom: 53.5, ratio: 1332 / 1000 },
        ...
        { ref: useRef(null), id: "mountain", type: "transparent", audio: 0.3, zoom: 40, height: 16, left: -52, bottom: 71.5, ratio: 1600 / 480 },
    ...
    return (
        <div style={container} ref={containerRef}>
            ...
            <div style={{ zIndex: "-4", height: "75.5%", position: "absolute", bottom: 0, left: "calc(50% - max(49dvh,147px))" }}>
                ...
                <BeingAudio id={'river'} volume={0.5} currentSpeakerId={currentSpeakerId} audioContext={audioContext} />
            </div>
