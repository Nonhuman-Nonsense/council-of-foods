...
function Contact() {
  ...
  return (
    <div style={{display: "flex", flexDirection:"column", alignItems: "center"}}>
      <p style={wrapper}>
        The project is an initiative by art & design collective <a href="https://nonhuman-nonsense.com">Nonhuman&nbsp;Nonsense</a> developed in collaboration with <a href="https://studiootherspaces.net/">Studio&nbsp;Other&nbsp;Spaces</a>, <a href="https://www.in4art.eu/">In4Art</a>, <a href="https://elliott.computer/">Elliot&nbsp;Cost</a>, <a href="https://www.polymorf.se/">Albin&nbsp;Karlsson</a> and others.
      </p>
      <p>
        <a
