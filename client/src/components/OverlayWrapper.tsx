...
interface OverlayWrapperProps {
    ...
    isVisible?: boolean; // Prop was leaked in MainOverlays usage but not used in component props in JS version?
    // In MainOverlays.tsx: <OverlayWrapper showX={true} removeOverlay={removeOverlay} isVisible={true}>
    // So I should add isVisible to props even if unused to avoid error, or remove it from usage.
