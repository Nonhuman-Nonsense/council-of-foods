...
import { APP_MODE_STORAGE_KEY, setAppMode, setPushToTalk } from '@/settings/councilSettings';
...
function SettingsProbe() {
  ...
  return (
    <div>
      ...
      <button type="button" onClick={() => updateAppMode('web')}>to-web</button>
      <button type="button" onClick={() => setPushToTalkMode(true)}>enable-ptt</button>
    </div>
  );
}
