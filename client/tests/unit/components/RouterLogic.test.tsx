...
import { APP_MODE_STORAGE_KEY, MODE_SWITCH_BUTTON_ENABLED_KEY } from '@/settings/councilSettings';
...
vi.mock('@/museum/ModeSwitchButton', () => ({
    default: () => <div data-testid="mode-switch-button">Museum switch</div>
}));
