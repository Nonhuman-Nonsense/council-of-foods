# Test-suite inventory (generated 2026-09-08)
...
**Totals:** 167 test files, ~1460 cases
(client 112 files / 1016 cases, server 55 files / 444 cases).
...
|---|---|---|---|---|---|
| client/tests/unit/hooks/useCouncilMachine.test.tsx | 53 (+4 each) | 1774 |  | 2.8 | 48 |
| client/tests/unit/components/HumanInput.render.test.tsx | 51 | 1416 |  | 1.9 | 11 |
| client/tests/unit/realtime/realtimeEventLoop.test.ts | 21 (+2 each) | 836 |  | 2.9 | 6 |
| client/tests/unit/realtime/useRealtimeVoiceSession.test.ts | 23 (+1 each) | 809 |  | 3 | 18 |
| client/tests/unit/realtime/realtimeConnection.test.ts | 30 | 730 |  | 2.6 | 13 |
| client/tests/unit/museum/metaAgent/MeetingMetaAgent.test.tsx | 26 | 615 |  | 1.9 | 29 |
| client/tests/unit/setupAgent/useSetupAgent.test.ts | 27 | 584 |  | 2.2 | 16 |
| client/tests/unit/meetingSetup.test.ts | 35 (+1 each) | 576 |  | 2 | 15 |
| client/tests/unit/museum/button/buttonStore.test.ts | 39 (+1 each) | 570 |  | 2.5 | 18 |
| client/tests/unit/components/settings/SelectFoods.test.tsx | 24 (+1 each) | 565 |  | 2.3 | 7 |
| server/tests/DialogGenerator.test.js | 25 | 513 |  | 2.1 | 11 |
| client/tests/unit/setupAgent/setupAgentTools.test.ts | 49 | 508 |  | 1.6 | 6 |
| server/tests/meetingsHttpAndSocket.integration.test.js | 10 | 419 |  | 2.7 | 12 |
| client/tests/unit/components/settings/SelectTopic.test.tsx | 10 | 408 |  | 3.7 | 6 |
...
| client/tests/e2e/src/button_setup.spec.ts | 4 | 98 |  | 1 | 10 |
| server/tests/ValidationCustomVoice.test.ts | 4 | 90 |  | 1 | 5 |
| client/tests/unit/components/OverlayWrapper.test.tsx | 4 | 65 |  | 1 | 3 |
| client/tests/unit/components/overlays/Incomplete.test.tsx | 5 | 64 |  | 1 | 5 |
| client/tests/unit/api/httpErrorMessage.test.ts | 7 | 40 |  | 1 | 1 |
| client/tests/unit/components/CouncilOverlays.test.tsx | 9 | 159 |  | 1.1 | 15 |
| client/tests/unit/main/overlay/errorStore.test.ts | 12 | 99 |  | 1.1 | 2 |
| client/tests/unit/museum/button/buttonIntent.test.ts | 15 | 99 |  | 1.1 | 7 |
...
| server/tests/AudioUtils.test.ts | 16 | 191 |  | 1.3 | 4 |
| client/tests/unit/setupAgent/useInactivityNudge.test.ts | 6 | 117 |  | 1.3 | 1 |
...
| client/tests/unit/setupAgent/useAgentPresence.test.ts | 10 | 230 |  | 1.4 | 2 |
| server/tests/textUtils.test.js | 15 | 172 |  | 1.4 | 3 |
| client/tests/unit/api/realtimeSession.test.ts | 5 | 113 |  | 1.4 | 3 |
| client/tests/unit/museum/ModeSwitchButton.test.tsx | 7 | 95 |  | 1.4 | 0 |
| client/tests/unit/setupAgent/setupAgentPrompt.test.ts | 7 | 61 |  | 1.4 | 6 |
...
| client/tests/unit/components/overlays/Summary.test.tsx | 11 | 354 |  | 2.5 | 16 |
| client/tests/unit/components/Staff.test.tsx | 23 | 352 |  | 2.5 | 5 |
| client/tests/unit/autoplay/AutoplayCoordinator.test.tsx | 13 (+1 each) | 337 |  | 2.1 | 10 |
| client/tests/unit/components/Council.test.tsx | 10 | 325 |  | 1.6 | 37 |
| client/tests/unit/components/LiveAudioVisualizer.test.tsx | 7 | 268 |  | 3.7 | 4 |
| client/tests/unit/museum/button/buttonBanner.test.ts | 17 | 260 |  | 1.2 | 4 |
| client/tests/unit/museum/metaAgent/metaAgentPrompt.test.ts | 24 | 259 |  | 2.3 | 9 |
| client/tests/unit/realtime/inworldSubtitleTrack.test.ts | 23 | 252 |  | 1.6 | 1 |
| client/tests/unit/setupAgent/MeetingSetupAgent.ptt.test.tsx | 11 | 247 |  | 1.5 | 6 |
| client/tests/unit/council/summaryScrollSync.test.ts | 14 | 241 |  | 1.4 | 3 |
| client/tests/unit/components/RouterLogic.test.tsx | 8 | 238 |  | 1.9 | 17 |
| client/tests/unit/settings/councilSettings.test.tsx | 19 | 233 |  | 2.3 | 6 |
| client/tests/unit/setupAgent/useAgentPresence.test.ts | 10 | 230 |  | 1.4 | 2 |
| client/tests/unit/components/MeetingSetupReset.test.tsx | 3 | 214 |  | 2.7 | 6 |
| client/tests/foods/Main.test.tsx | 4 | 204 |  | 1.5 | 3 |
| client/tests/unit/logger.test.ts | 12 | 204 |  | 1.8 | 7 |
| client/tests/unit/AutoButton.test.tsx | 7 | 203 |  | 2.4 | 1 |
| client/tests/unit/setupAgent/MeetingSetupAgent.reactions.test.tsx | 6 | 199 |  | 2 | 5 |
| client/tests/unit/realtime/RealtimeCaptionOverlay.test.tsx | 12 | 194 |  | 1.8 | 10 |
| client/tests/unit/components/FoodItem.test.tsx | 7 | 178 |  | 2.4 | 5 |
| client/tests/unit/components/HumanInput.test.tsx | 15 | 175 |  | 1.9 | 8 |
| client/tests/unit/main/overlay/Reconnecting.test.tsx | 5 | 170 |  | 1.6 | 7 |
| client/tests/unit/components/FoodAnimation.test.tsx | 6 | 168 |  | 2 | 8 |
| client/tests/unit/realtime/micAvailabilityStore.test.ts | 10 | 167 |  | 2 | 3 |
| client/tests/unit/components/ConversationControls.test.tsx | 12 | 166 |  | 2.3 | 3 |
| client/tests/unit/components/CouncilOverlays.test.tsx | 9 | 159 |  | 1.1 | 15 |
| client/tests/unit/main/overlay/CouncilError.test.tsx | 4 | 149 |  | 2 | 3 |
| client/tests/unit/components/AudioOutputMessage.test.tsx | 5 | 147 |  | 2.2 | 6 |
| client/tests/unit/components/NewMeeting.creatorKey.test.tsx | 1 | 146 |  | 4 | 17 |
| client/tests/unit/museum/useMuseumCursorHide.test.ts | 7 | 142 |  | 2 | 2 |
| client/tests/unit/components/settings/Landing.test.tsx | 5 | 139 |  | 2.2 | 17 |
| client/tests/unit/components/Main.test.tsx | 2 | 137 |  | 1.5 | 5 |
| client/tests/unit/components/TextOutput.test.tsx | 6 | 137 |  | 2.7 | 5 |
| client/tests/unit/setupAgent/SetupAgentOverlay.test.tsx | 6 | 136 |  | 1.5 | 9 |
| client/tests/unit/components/MainOverlays.test.tsx | 10 | 135 |  | 1.6 | 11 |
| client/tests/unit/museum/button/buttonIntentIntegration.test.tsx | 5 | 134 |  | 2.8 | 5 |
| client/tests/unit/navigation/reloadApp.test.ts | 5 | 132 |  | 2.8 | 4 |
| client/tests/unit/settings/capabilities.test.ts | 4 (+1 each) | 130 |  | 2.8 | 3 |
| client/tests/unit/audio/canAutoplay.test.ts | 5 | 128 |  | 3.2 | 1 |
| client/tests/unit/audio/wakeLock.test.ts | 7 | 119 |  | 1.9 | 1 |
| client/tests/unit/museum/button/useButton.test.ts | 5 | 117 |  | 2.8 | 5 |
| client/tests/unit/setupAgent/useInactivityNudge.test.ts | 6 | 117 |  | 1.3 | 1 |
...
| client/tests/unit/ValidateFoodData.test.ts | 2 | 110 |  | 9 | 5 |
...
| client/tests/unit/setupAgent/setupAgentPrompt.test.ts | 7 | 61 |  | 1.4 | 6 |
| client/tests/unit/museum/button/hardwareButton.test.tsx | 3 | 59 |  | 1.7 | 1 |
| client/tests/unit/FoodVideoIntegrity.test.ts | 1 | 58 |  | 6 | 5 |
...
| client/tests/unit/main/overlay/MicrophoneBlocked.test.tsx | 2 | 48 |  | 1 | 1 |
| client/tests/unit/realtime/realtimeProtocol.test.ts | 2 | 47 |  | 2.5 | 3 |
| client/tests/e2e/src/meeting_flow.spec.ts | 2 | 46 |  | 6 | 6 |
| client/tests/unit/components/MediaPreloader.test.tsx | 3 | 46 |  | 4 | 1 |
...
| client/tests/unit/main/ErrorBoundary.test.tsx | 2 | 41 |  | 1.5 | 1 |
| client/tests/unit/api/httpErrorMessage.test.ts | 7 | 40 |  | 1 | 1 |
...
| server/tests/DialogGenerator.test.js | 25 | 513 |  | 2.1 | 11 |
| server/tests/meetingsHttpAndSocket.integration.test.js | 10 | 419 |  | 2.7 | 12 |
| server/tests/realtimeProviders.test.ts | 11 (+1 each) | 396 |  | 2.5 | 14 |
| server/tests/AudioSystemInworld.test.js | 8 | 395 |  | 2 | 8 |
| server/tests/ConversationFlow.test.js | 10 | 364 |  | 4.8 | 21 |
| server/tests/SpeakerSelection.test.js | 27 | 349 |  | 1 | 8 |
| server/tests/replayManifest.test.ts | 24 | 339 |  | 1.5 | 16 |
| server/tests/realtimeSessionApi.integration.test.ts | 12 | 327 |  | 2.7 | 7 |
...
| server/tests/PronunciationUtils.test.ts | 22 | 245 |  | 1.9 | 4 |
| server/tests/AudioSystem.test.js | 8 | 240 |  | 1.8 | 5 |
...
| server/tests/SummaryGeneration.test.ts | 2 | 219 |  | 6 | 4 |
| server/tests/SummaryPendingConclude.test.js | 9 | 218 |  | 2.6 | 2 |
| server/tests/ConnectionHandler.test.js | 8 | 207 |  | 2.9 | 9 |
| server/tests/resumeMeeting.test.ts | 9 | 204 |  | 3 | 7 |
| server/tests/AudioUtils.test.ts | 16 | 191 |  | 1.3 | 4 |
| server/tests/DecisionLogic.test.js | 0 | 186 |  | 0 | 12 |
| server/tests/LoggingAndReporting.test.js | 12 | 174 |  | 1.6 | 8 |
| server/tests/characterSetupBundle.test.ts | 10 | 172 |  | 1.6 | 4 |
| server/tests/textUtils.test.js | 15 | 172 |  | 1.4 | 3 |
| server/tests/GenerationRetry.test.js | 6 | 164 |  | 2.8 | 1 |
| server/tests/Concurrency.test.js | 2 | 154 |  | 7 | 6 |
| server/tests/spaShell.test.ts | 15 | 153 |  | 4.7 | 1 |
| server/tests/SocketManager.reconnectRace.test.js | 2 | 123 |  | 3 | 1 |
| server/tests/SubtitleTimingValidation.test.ts | 7 | 119 |  | 1.6 | 3 |
| server/tests/NetworkUtils.test.ts | 9 | 111 |  | 1.8 | 1 |
| server/tests/ClientReportRoute.test.ts | 9 | 109 |  | 1.8 | 2 |
| server/tests/SummaryMarkdownHandling.test.ts | 1 | 108 |  | 11 | 14 |
...
| server/tests/MarkdownStripping.test.ts | 6 | 51 |  | 2.5 | 0 |
