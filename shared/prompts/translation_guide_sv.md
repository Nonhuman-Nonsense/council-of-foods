...
| biosphere reserve | biosfärområde | |
...
| Banned word: human rights | mänskliga rättigheter | (in the *banned* list) |
| Banned word: mitigation | begränsning / skadelindring | (in the *banned* list) |
...
5. **Several beings gained/changed sections** in English that the Swedish lacks:
   ...
   topic...` block, restructured task lists (River), and expanded archives
